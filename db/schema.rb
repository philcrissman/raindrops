...
ActiveRecord::Schema.define(version: 20160315054626) do
  ...
  add_index "people", ["last_logout_at", "last_activity_at"], name: "index_people_on_last_logout_at_and_last_activity_at", using: :btree
